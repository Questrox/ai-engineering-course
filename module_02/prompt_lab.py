...
Примеры:
Обращение: "Линия перестала работать" -> инцидент
Обращение: "Стажера нужно зарегистрировать в системе" -> доступ
Обращение: "В какой срок нужно оформить карточку инцидента после остановки?" -> регламент
Обращение: "Прошу предоставить паспорт пресса П-7 " -> документация
"""
...
Например, если в обращении есть слово \"инцидент\" или \"регламент\", то это не значит, что они автоматом попадают под эту категорию, смотри именно на общий смысл.
